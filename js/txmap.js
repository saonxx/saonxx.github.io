...
$.ajax({
    ...
    data: {
        key: 'BSFBZ-OGAK3-K4O3F-R7CPO-GWVCE-U4BZQ',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(113.822898, 22.909183, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
